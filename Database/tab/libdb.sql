...
-- ----------------------------
-- Table structure for author_copy1
-- ----------------------------
DROP TABLE IF EXISTS `author_copy1`;
CREATE TABLE `author_copy1`  (
...
-- ----------------------------
-- Records of author_copy1
-- ----------------------------
INSERT INTO `author_copy1` VALUES (1, '鲁迅', '男', '浙江绍兴', '无');
