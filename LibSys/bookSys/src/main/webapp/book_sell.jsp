    ...
    <script>
        ...
        $(function(){
            ...
            $("#btnQuery").click(function(){
                ...
                var url="vip.let?type=doajax&idn="+content;
                $.get(url,function(data,status){
                    ...
                    $("#balance").val(member.clientBalance);
            ...
            $("#btnQueryBook").click(function(){
                ...
                var url = "booknew.let?type=doajax&name="+name;
                $.get(url,function(data,status){
                    //{}/一本书的json
                    console.log(data);
                    //特殊情况 {}
                    ...
                    //2.创建多个列
                    var tdCheck = $("<td><input type=\"checkbox\" value=\""+book.bookIsbn+"\" class=\"ck\" checked /></td>");
            ...
            $("#btnSubmit").click(function(){
                ...
                // if(count>member.clientBorrowNum){
                //     alert("借阅数量超出范围");
                //     return;
                // }
               //请求servlet http://localhost:8888/mybook_war_exploded/record.let?type=add&mid=1&ids=5_4_9_10
                location.href="sell.let?type=add&mid="+member.clientPhone+"&ids="+ids.join("_");
            });
        });
                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">常用功能 > 图书零售 </h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                    ...
                                    <table width="100%" border="1" class="cont"  >
                                        <tr>
                                            <td colspan="8">
                                                ...
                                                请输入:&nbsp;&nbsp;<input class="text" type="text" id="bookContent" name="bookContent" placeholder="输入书名"/>
