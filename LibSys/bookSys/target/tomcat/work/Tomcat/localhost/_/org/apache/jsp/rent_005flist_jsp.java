 ...
 * Generated at: 2022-12-07 02:16:40 UTC
...
public final class rent_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                // 组成url\r\n");
      out.write("                var url = \"borrow.let?type=doajax&typeId=\"+typeId+\"&keyword=\"+keyword;\r\n");
      out.write("                // 发送并获取数据\r\n");
      ...
      out.write("                    }\r\n");
      out.write("\r\n");
      out.write("                    // data=>json对象\r\n");
      out.write("                    var records = JSON.parse(data);\r\n");
      out.write("                    for(var i=0;i<records.length;i++){\r\n");
      out.write("                       var record =  records[i];\r\n");
      out.write("                       //tr\r\n");
      out.write("                        var tdPhone = $(\" <td>\"+record.clientPhone+\"</td>\");\r\n");
      out.write("                        var tdMName = $(\" <td>\"+record.clientName+\"</td>\");\r\n");
      out.write("                        var tdBName = $(\"<td>\"+record.bookName+\"</td>\");\r\n");
      out.write("                        var tdRentDate = $(\"<td>\"+record.borrowDate+\"</td>\");\r\n");
      out.write("                        var tdBackDate = $(\"<td>\"+ (record.returnDate===undefined?\"\":record.returnDate)+\"</td>\");\r\n");
      out.write("                        var tdDeposit = $(\"<td>\"+record.expiryDate+\"</td>\");\r\n");
      out.write("                        var dateDeposit = new Date(record.expiryDate);\r\n");
      out.write("                        if (record.returnDate!==undefined) {\r\n");
      out.write("                            var dateRet = new Date(record.returnDate);\r\n");
      out.write("                        }\r\n");
      out.write("                        var dateNow = new Date();\r\n");
      out.write("                        var tr = undefined;\r\n");
      out.write("                        console.log(record.returnDate!==undefined && dateRet > dateDeposit);\r\n");
      out.write("                        if ( (record.returnDate===undefined && dateDeposit < dateNow) || (record.returnDate!==undefined && dateRet > dateDeposit) ) {\r\n");
      out.write("                            tr = $(\" <tr align=\\\"center\\\" class=\\\"d\\\" bgcolor=#fecdcd>\");\r\n");
      out.write("                        } else {\r\n");
      out.write("                            tr = $(\" <tr align=\\\"center\\\" class=\\\"d\\\">\");\r\n");
      out.write("                        }\r\n");
      out.write("                        //5-td\r\n");
      out.write("                        tr.append(tdPhone);\r\n");
      ...
      out.write("                        // console.log(dateDeposit);\r\n");
      out.write("                        // console.log(dateNow);\r\n");
      out.write("\r\n");
      out.write("                        // 加入到表\r\n");
      ...
      out.write("                                                <input type=\"radio\" name=\"query\" value=\"3\"/>最近一周需归还 &nbsp;&nbsp;\r\n");
      out.write("                                                请输入关键字:&nbsp;&nbsp;<input class=\"text\" type=\"text\" id=\"keyword\" name=\"keyword\"/> \r\n");
