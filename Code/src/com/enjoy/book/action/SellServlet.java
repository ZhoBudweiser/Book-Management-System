...
import com.enjoy.book.biz.SellBiz;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch(type){
            case "add":
               ...
               if(count>0){
                   out.println("<script>alert('图书购买成功');location.href='main.jsp';</script>");
               }else{
                   out.println("<script>alert('图书购买失败');location.href='main.jsp';</script>");
               }
                break;
//            case "queryback":
//                 //1.获取会员的身份证号
