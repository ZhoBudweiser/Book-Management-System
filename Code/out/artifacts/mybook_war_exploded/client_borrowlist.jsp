    ...
    <script>
        ...
        $(function(){
            $("#btnQuery").click(function(){
                ...
                //3.组成url
                var url = "sell.let?type=doajax&typeId=1&keyword="+keyword;
                //4.发送并获取数据
                ...
                //5.数据加载到页面
                    ...
                    for(var i=0;i<records.length;i++){
                       ...
                       //tr
                        ...
                        var tdborrowNum = $("<td>"+record.borrowNum+"</td>");
                        //5-td
                        tr.append(tdPhone);
                        tr.append(tdMName);
                        tr.append(tdBName);
                        tr.append(tdborrowNum);
                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">常用功能 > 用户借阅数量记录 </h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
...
<%--                                                <input type="hidden" name="query" value="0" checked/>全部 &nbsp;&nbsp;--%>
                                                请输入联系方式:&nbsp;&nbsp;<input class="text" type="text" id="keyword" name="keyword"/>
