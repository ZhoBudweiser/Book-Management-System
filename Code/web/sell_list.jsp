    ...
    <script>
        ...
        $(function(){
            $("#btnQuery").click(function(){
                ...
                //3.组成url
                var url = "sell.let?type=doajax&typeId=0&keyword="+keyword;
                //4.发送并获取数据
                ...
                //5.数据加载到页面
                    ...
                    for(var i=0;i<records.length;i++){
                       ...
                       //tr
                        ...
                        var tdRentDate = $("<td>"+record.buyDate+"</td>");
                        //5-td
                        tr.append(tdPhone);
                        tr.append(tdMName);
                        tr.append(tdBName);
                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">常用功能 > 销售历史记录 </h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
